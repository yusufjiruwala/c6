sap.ui.jsfragment("bin.forms.fa.faMain", {
    ...
    load_data: function (period) {
        ...
        var sql = "select fi.CODE, fi.CATNO, fi.ACCNO, fi.DEPACCNO, " +
            "fi.EXPACCNO, fi.PURPRICE, fi.PURDATE, fi.NETBOOKVALUE, " +
            "fi.LASTDEPDATE, fi.DEPRATE, fi.DEPTYPE, fi.PRIORDEP, " +
            "fi.CURRENTVALUE, fi.PRIORDEPDATE, fi.PRIORDEPAMT," +
            " fi.COSTCENT, fi.DESCR, fi.USE_YR, fi.PUR_INV_DATE " +
            " from faitems " +
            " order by ";
