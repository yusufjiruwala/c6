    ...
    createView: function () {
        ...
        var frm1 = UtilGen.formCreate("{i18n>athlet_info}", true,
            [
                ...
                "Hydro", this.subs.hydro_refer, this.subs.hydro, this.subs.price_hydro, this.subs._amt_hydro,
                "PT", this.subs.pt_refer, this.subs.pt, this.subs.price_pt, this.subs._amt_pt,
